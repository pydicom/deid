...
class TestRuleInteractions(unittest.TestCase):
    ...
    def test_keep_remove_single_private_tag_should_be_original_value_2(self):
        ...
        print(
            'Test KEEP/REMOVE private tags Interaction with tag syntax (0033,"MITRA OBJECT UTF8 ATTRIBUTES 1.0",1E)'
        )
        dicom_file = get_file(self.dataset)
    ...
    def test_private_tag_replace_blank_should_be_blank(self):
        ...
        print("Test REPLACE/BLANK Interaction for private tag with new syntax")
        dicom_file = get_file(self.dataset)
    ...
    def test_private_tag_replace_jitter_should_combine(self):
        ...
        print("Test REPLACE/JITTER Interaction for private tags with new syntax")
        dicom_file = get_file(self.dataset)
