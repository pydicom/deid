...
# -*- coding: utf-8 -*-
#
# deid documentation build configuration file, created by
...
latex_documents = [
    ("index", "deid.tex", "deid Documentation", "Vanessa Sochat", "manual"),
]
...
texinfo_documents = [
    (
        ...
        ["Vanessa Sochat"],
        "deid",
        "deid is for best effort dicom header cleaning.",
        "Miscellaneous",
    ),
]
