...
A full anonymization process has four parts:

 1. define a set of rules for de-identification
...
[the client]({{ site.baseurl }}/getting-started/client).
...
For a standard de-identification, you will likely want to extract data, replace some fields, 
...
#### Pixels
The `%pixels` section has not been implemented yet, but will allow for 
specification of how to de-identify pixel data.
...
Now that you know how configuration works, you have two options. If you care 
about interacting with your recipe via a client, [read about that here]({{ site.baseurl }}/getting-started/recipe). 
