...
As of the version 0.4.5, deid supports enhanced private tag syntax for precise private tag matching.
...
The private creator syntax is built with: `GROUP,"PRIVATE_CREATOR",ELEMENT`

- GROUP: 4-digit hexadecimal group number (e.g., 0033)
- PRIVATE_CREATOR: Exact private creator string in double quotes
- ELEMENT: 2-digit hexadecimal element number (last 8 bits of full element)
